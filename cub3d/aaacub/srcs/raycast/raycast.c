...
/*   Updated: 2023/02/01 20:19:14 by sanghan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define TILE_SIZE    32
# define WIDTH2        33 * TILE_SIZE
# define HEIGHT2        14 * TILE_SIZE
...
void    draw_square(t_game *game, int x, int y, int color)
{
    ...
    while (dy < TILE_SIZE)
    {
        ...
        while (dx < TILE_SIZE)
        {
            game->img.data[WIDTH2 * (y + dy) + (x + dx)] = color;
            dx++;
        }
        dy++;
    }
...
void    draw_lines(t_game *game)
{
    ...
    while (i <= game->map_y)
    {
        draw_line(game, 0, TILE_SIZE * i, WIDTH2, TILE_SIZE * i);
        i++;
    }
    i = 0;
    while (i <= game->map_x)
    {
        draw_line(game, TILE_SIZE * i, 0, TILE_SIZE * i, HEIGHT2);
        i++;
    }
}
